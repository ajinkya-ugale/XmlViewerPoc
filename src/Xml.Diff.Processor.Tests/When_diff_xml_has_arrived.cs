...
namespace Xml.Diff.Processor.Tests
{
  ...
  public class When_Result_Xml_Processing_Start : ResultXmlProcessor
  {
    ...
    [Test]
    public void When_DeleteNode_Method_call_it_should_add_deletednode_and_attribute_information()
    {
    ...
    [Test]
    public void When_AddNodeattr_Method_call_it_should_add_new_node_and_added_new_node_information()
    {
    ...
    [Test]
    public void When_AddSingleNode_Method_call_it_should_add_information_of_added_node()
    {
      AddNewAttributeAndAddedNewNodeInformationInResult addNewAttributeAndAddedNewNodeInformationInResult = new AddNewAttributeAndAddedNewNodeInformationInResult();
    ...
    [Test]
    public void When_ProcessNode_Method_call_should_add_process_node_information()
    {
      AddNewAttributeAndAddedNewNodeInformationInResult addNewAttributeAndAddedNewNodeInformationInResult = new AddNewAttributeAndAddedNewNodeInformationInResult();
    ...
    [Test]
    public void When_RenameTag_Method_call_it_should_rename_tag_name()
    {
    ...
    [Test]
    public void When_DeleteAttr_Method_call__it_should_delete_moved_and_deleted_attribute()
    {
    ...
    [Test]
    public void When_AddCrestId_Method_call_it_should_add_crest_id_in_result_xml()
    {
      AddCrestId addCrestId = new AddCrestId();
      XDocument expectedResult = XDocument.Parse("<b cs_crestid=\"1\"><a>Some text 1</a><b>Some text 2</b><c cs_crestid=\"3\">Some text 3</c><d cs_crestid=\"4\">Another text<fob /></d><x firstAttr=\"value1\" secondAttr=\"value2\" cs_crestid=\"5\" /><y><!--Any comments?--><z id=\"10\">Just another text</z></y></b>");
      XDocument resultXDoc = XDocument.Parse("<b><a>Some text 1</a><b>Some text 2</b><c>Some text 3</c><d>Another text<fob /></d><x firstAttr=\"value1\" secondAttr=\"value2\" /><y><!--Any comments?--><z id=\"10\">Just another text</z></y></b>");
      Assert.AreEqual(expectedResult.ToString(), addCrestId.AddCrestID(diffXDoc, resultXDoc).ToString());
    }

    [Test]
    public void When_AddCrestId_Method_call_it_should_not_return_null()
    {
      AddCrestId addCrestId = new AddCrestId();
      XDocument resultXDoc = XDocument.Parse("<b><a>Some text 1</a><b>Some text 2</b><c>Some text 3</c><d>Another text<fob /></d><x firstAttr=\"value1\" secondAttr=\"value2\" /><y><!--Any comments?--><z id=\"10\">Just another text</z></y></b>");
      Assert.AreNotEqual(null, addCrestId.AddCrestID(diffXDoc, resultXDoc).ToString());
    }
  }
